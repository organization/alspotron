export const userCSSSelectors = {
  ...
  'lyrics-wrapper--previous': 'alspotron-usercss-lyrics-wrapper--previous',
  'lyrics-wrapper--current': 'alspotron-usercss-lyrics-wrapper--current',
  'lyrics-wrapper--next': 'alspotron-usercss-lyrics-wrapper--next',
