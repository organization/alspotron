  ...
  return (
    <div class={'w-full flex justify-start items-center gap-1 font-mono'}>
      <Show when={props.showPlugin}>
        <span class={'text-primary-500 overflow-visible whitespace-nowrap font-mono'}>
      ...
      <Switch>
        <Match when={props.log.type === 'error'}>
          <span class={'text-red-500 overflow-visible whitespace-nowrap font-mono'}>
            [ERROR]
          </span>
        </Match>
        <Match when={props.log.type === 'warn'}>
          <span class={'text-yellow-500 overflow-visible whitespace-nowrap font-mono'}>
            [WARN]
          </span>
        </Match>
        <Match when={props.log.type === 'info'}>
          <span class={'text-blue-500 overflow-visible whitespace-nowrap font-mono'}>
            [INFO]
          </span>
        </Match>
        <Match when={props.log.type === 'debug'}>
          <span class={'text-slate-500 overflow-visible whitespace-nowrap font-mono'}>
            [DEBUG]
          </span>
        </Match>
