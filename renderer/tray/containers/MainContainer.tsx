    ...
    <div class={'w-full h-full flex flex-col justify-start items-stretch'}>
      <div class={'w-full flex justify-start items-center gap-2 p-4 pb-0'}>
        <div class={'text-lg font-bold flex-1 flex justify-start items-center gap-1'}>
          <img src={MainIcon} class={'w-5 h-5 object-contain'} alt={'Main Icon'} />
          Alspotron
        </div>
      ...
      <div class={'grid grid-cols-2 justify-start items-stretch gap-2 p-4'}>
        <button class={'btn-text btn-icon flex gap-1 justify-center items-center'} onClick={onSetting}>
        ...
        <button class={'btn-text btn-icon flex gap-1 justify-center items-center'} onClick={onSearch}>
          <svg class={'w-[18px] h-[18px] fill-none'} xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960">
            <path
